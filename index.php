...
<html lang="en">
    <head>
        ...
        <title>SANKHARA Group | Driving Innovation and Excellence Across Industries</title>
        <meta name="title" content="SANKHARA Group | Driving Innovation and Excellence Across Industries" />
        <meta
            name="description"
            content="SANKHARA Group: A leading conglomerate driving innovation and excellence across diverse industries. Discover our innovative solutions, cutting-edge technologies, and commitment to sustainable growth."
        />
    ...
    <body>
        ...
        <section class="header-banner">
            <video autoplay muted loop playsinline loading="lazy" class="banner-video">
            ...
            <div class="banner-content text-center my-5">
                ...
                <h1 class="mt-3" style="font-weight: 600;">
                    "We <span class="text-custom">SANKHARA Group</span> is a community of innovators committed to delivering exceptional products and services that inspire creativity and drive sustainable growth."
                </h1>
                ...
                <div class="row">
                    <div class="col-lg-7 text-start">
                        ...
                        <h2 class="section-title">
                            We Deliver <span class="text-custom" style="font-weight: 800;"><u>Extraordinary</u></span><br />
                    ...
                    <div class="col-lg-5 text-end">
                        ...
                        <p class="m-3">
                            <b> We specialize in crafting exceptional digital experiences, seamlessly blending innovation and creativity to deliver unforgettable interactions that captivate and inspire our clients and their audiences.</b>
                        </p>
                    </div>
                </div>
                <div class="container custom-container mt-2">
                    <div class="row services-container custom-container">
                        <!-- Added row for service cards -->
                        <div class="col-lg-6 mb-4">
                            <!-- Each card occupies half the width -->
                            <div class="service-card d-flex flex-column p-4 align-items-center justify-content-center">
                                <!-- Added flex-column for consistent height -->
                                <div class="row align-items-center justify-content-center">
                                    <!-- Align items vertically -->
                                    <div class="col-lg-4 d-flex align-items-center justify-content-center">
                                        <img src="assets/images/services/1.png" alt="Sankhara Digital Icon" class="img-fluid" />
                                        <!-- Responsive image -->
                                    </div>
                            ...
                            <div class="service-card d-flex flex-column p-4 align-items-center justify-content-center">
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-lg-8 align-items-center justify-content-center">
                                        ...
                                        <p class="text-center">
                                            We're at the forefront of cutting-edge technologies, leveraging advancements like AI, machine learning, cloud computing, and big data to deliver tailored solutions that drive your business
                                            forward.
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="container custom-container">
                ...
                <!-- <div class="row">
                    <div class="col-lg-5 d-flex align-items-center justify-content-end">
                        <h1 class="succeed text-custom py-5" style="font-size: 3rem; font-weight: 800;">SUCCEED</h1>
                    </div>
                    <div class="col-lg-7"></div>
                    <div class="col-lg-6">
                        <div class="d-flex align-items-center justify-content-end overflow-hidden">
                            <img src="assets/images/logo/group.png" class="img-fluid sh-logo" alt="Sankhara Group Logo" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-center">
                        <h1 class="strategize text-custom py-3" style="font-size: 3rem; font-weight: 800;">STRATEGIZE</h1>
                    </div>

                    <div class="col-lg-5 d-flex align-items-center justify-content-end">
                        <h1 class="sustain text-custom py-5" style="font-size: 3rem; font-weight: 800;">SUSTAIN</h1>
                    </div>
                    <div class="col-lg-7"></div>
                </div> -->
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mx-auto pb-4">
                            <h2 class="text-custom" style="font-weight: 800;">Our Esteemed Clients</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-carousel owl-carousel-press owl-theme">
                    <div class="item">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                <h6 class="card-title">Elevating Digital Presence: Website Design and Development for S K Technosys</h6>
                                <p
                                    class="card-text text-custom-gray"
                                    data-full-text="Enhance your online visibility and drive business growth with a cutting-edge website. Our team of experts specializes in website design, web development, and digital marketing to create a seamless digital experience for your audience."
                                >
                                    Enhance your online visibility and drive business growth with a cutting-edge website
                                    <span class="read-more" style="color: blue; cursor: pointer;">...</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                <h6 class="card-title">SHANKHARA Digital Boosts Brand Awareness and Lead Generation For Dr. Dentitia</h6>
                                <p
                                    class="card-text text-custom-gray"
                                    data-full-text="SHANKHARA Digital, a leading digital marketing agency, has successfully implemented a comprehensive digital marketing strategy for Dr. Dentitia, a renowned dental practice."
                                >
                                    SHANKHARA Digital, a leading digital marketing agency, has successfully implemented
                                    <span class="read-more" style="color: blue; cursor: pointer;">...</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                <h6 class="card-title">Smiling Success : How Our Marketing Increased Patient Acquistion for a Dental Clinic?</h6>
                                <p
                                    class="card-text text-custom-gray"
                                    data-full-text="In today's competitive healthcare market, dental clinics need effective marketing strategies to attract and retain patients. SHANKHARA Digital recently spearheaded a successful campaign for Dr. Dentitia, a renowned dental practice, that significantly boosted patient acquisition"
                                >
                                    In today's competitive healthcare market, dental clinics need effective marketing
                                    <span class="read-more" style="color: blue; cursor: pointer;">...</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="card h-100 shadow-sm">
                            <img src="assets/images/press/3.png" alt="Design System for Pepperfry" class="card-img-top" style="height: 150px; object-fit: cover;" />
                            <div class="card-body">
                                <h6 class="card-title">SANKHARA Digital Achieved Immense Results by the Effectiveness of Targeted SEO and PPC Campaigns For S K TECHNOSYS.</h6>
                                <p
                                    class="card-text text-custom-gray"
                                    data-full-text="SHANKHARA Digital, a leading digital marketing agency, has successfully implemented a strategic SEO and PPC campaign for S K TECHNOSYS, a prominent technology solutions provider. The campaign aimed to increase organic visibility, generate high-quality leads, and ultimately drive business growth."
                                >
                                    SHANKHARA Digital, a leading digital marketing agency, has successfully implemented
                                    <span class="read-more" style="color: blue; cursor: pointer;">...</span>
                                </p>
        ...
        <section id="trusted-partners" class="py-5 mb-2">
            <div class="container custom-container">
                <h2 class="text-center mb-4 text-custom-gray" style="font-weight: 800;">OUR TRUSTED PARTNERS</h2>
        ...
        <section class="blog bg-10 py-4">
            <div class="container custom-container">
                <div class="blog-section-title row mb-3">
                    <h4 class="p-1 text-custom-gray col-lg-6">Blogs that make unleashing Impact.</h4>
                    <a href="path/to/your/press/releases" class="btn col-lg-6 text-end">See All <i class="fas fa-arrow-right section-title"></i></a>
                </div>
                    ...
                    <div class="item blog-card p-1 gradient-background rounded d-flex flex-column align-items-center justify-content-center">
                        <div class="row align-items-start justify-content-start">
                            ...
                            <div class="col-lg-5 d-flex align-items-center justify-content-center">
                                <h3 class="p-4 text-white justify-content-center">Tech news delivering insights, trends, and breakthroughs to keep you informed and inspired.</h3>
                            </div>
                        </div>
                    </div>
        ...
        <section class="testimonials-section">
            <div class="container-fluid bg-10 py-5">
                <h2 class="mb-3 px-4 text-custom-gray">Testimonials</h2>
                <div class="owl-carousel owl-carousel-testimonials owl-theme">
                    <div class="item">
                        <div class="testimonial-card bg-20 p-4 text-custom-gray">
                            <!-- Logo in top-right corner -->
                            <div class="testimonial-logo-fit">
                                <img src="assets/images/logo/sh-digital-logo1.png" alt="Logo" class="testi img-fluid" />
                            </div>

                            <div class="d-flex align-items-center mb-3">
                                <img src="assets/images/testi/DrRevathiM.png" alt="User Image" class="user-image me-3" />
                                <div class="text-start">
                                    <!-- Star rating aligned next to name/title -->
                                    ...
                                    <h5 class="mb-0 text-custom">Dr. Revathi M</h5>
                                    <p class="mb-0">Founder & Managing Director of Dentitia Multispeciality Dental Clinic</p>
                                </div>
                            </div>
                            <p class="testimonial-text">
                                “Working with Arjun and his team has been a game-changer for our business. Their team brought a fresh perspective to our marketing strategy, creating a unique, targeted approach that truly speaks to our
                                audience. From innovative social media campaigns to highly effective SEO strategies, they consistently deliver results that exceed our expectations. Not only are they knowledgeable and creative, but they also
                                prioritize communication and transparency, keeping us informed at every step. We’ve seen a noticeable increase in engagement and conversions since partnering with them. Highly recommend Arjun and his team to
                                any business looking to elevate their brand and grow their reach!”
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                const options = {
                    strings: ["We Sankhara Group is a community of innovators committed to delivering exceptional products and services that inspire creativity and drive sustainable growth."],
        ...
        <!-- read more for press relase -->
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                // Toggle "read more" functionality for description text
                $(".read-more").on("click", function () {
                    const parentParagraph = $(this).closest(".card-text");
                    const fullText = parentParagraph.data("full-text");

                    if (parentParagraph.hasClass("expanded")) {
                        // Collapse text
                        parentParagraph.text(fullText.split(" ").slice(0, 15).join(" ") + "... ");
                        $(this).text("Read more");
                        parentParagraph.removeClass("expanded");
                    } else {
                        // Expand text
                        parentParagraph.text(fullText);
                        $(this).text("Read less");
                        parentParagraph.addClass("expanded");
                    }
                });
            });
        </script>
